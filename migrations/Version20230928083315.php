 ...
 */
final class Version20230928083315 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sessions_exercise (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sessions_exercise_sessions (sessions_exercise_id INT NOT NULL, sessions_id INT NOT NULL, INDEX IDX_7F44648350D0686B (sessions_exercise_id), INDEX IDX_7F446483F17C4D8C (sessions_id), PRIMARY KEY(sessions_exercise_id, sessions_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sessions_exercise_exercise (sessions_exercise_id INT NOT NULL, exercise_id INT NOT NULL, INDEX IDX_4BFE2C8C50D0686B (sessions_exercise_id), INDEX IDX_4BFE2C8CE934951A (exercise_id), PRIMARY KEY(sessions_exercise_id, exercise_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
